...
const BackgroundCircles = (props: Props) => {
  return (
    ...
    <div className="absolute border border-[#F7AB0A] rounded-full opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse"/>
    <div className="absolute border border-[#333333] rounded-full opacity-20 h-[800px] w-[800px] absolute mt-52 animate-pulse"/>
    <div/>
    </motion.div>
  )
}
